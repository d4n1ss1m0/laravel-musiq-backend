...
class PlaylistController extends Controller
{
    ...
    public function addTrack(int $playlistId, AddTrackToPlaylistRequest $request)
    {
        try {
    ...
    public function removeTrack(int $playlistId, ManyTracksRequest $request)
    {
        try {
    ...
    public function order(int $playlistId, ManyTracksRequest $request)
    {
        try {
            $this->playlistService->changeOrder($playlistId, $request->trackIds);
        } catch (\Exception $e) {
            return $this->error($e->getMessage(), 'error', $e->getCode());
        }
    }
